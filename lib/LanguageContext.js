...
const translations = {
  en: {
    headline1: "Downtown & DIFC's finest,",
    headline2: "held for you tonight.",
    subheadline: "No calling ahead. No walk-in gamble.",
    ...
    continueSeating: "Continue to choose seating",
    ...
    myBookingsDesc: "Saved on this phone — reservations you've made or that friends shared with you.",
  ...
  ar: {
    headline1: "أفضل مطاعم داون تاون ومركز دبي المالي،",
    headline2: "محجوزة لك الليلة.",
    subheadline: "بدون اتصال مسبق. بدون مقامرة الحضور المباشر.",
    ...
    continueSeating: "متابعة لاختيار الجلسة",
    ...
    myBookings: "حجوزاتي",
    myBookingsDesc: "محفوظة على هذا الهاتف — حجوزات قمت بها أو شاركها معك أصدقاؤك.",
